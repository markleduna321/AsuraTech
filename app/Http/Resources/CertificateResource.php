...
class CertificateResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'speaker_signature_url' => $this->speaker_signature_path ? \Illuminate\Support\Facades\Storage::url($this->speaker_signature_path) : null,
            'speaker_role'     => $this->speaker_role,
            'coordinator_name' => $this->coordinator_name,
            'coordinator_signature_url' => $this->coordinator_signature_path ? \Illuminate\Support\Facades\Storage::url($this->coordinator_signature_path) : null,
